...
* Kategorien primitiver Objekttypen [base::typeof()]: **Basic Vector** (Vektor mit einem Datentyp), **Compund objects** (Listen und S4-Objekte), Special objects, R language, **Functions**, Internal, Bytecode Objects 
...
# vectors und data.frames zuweisen/anlegen
