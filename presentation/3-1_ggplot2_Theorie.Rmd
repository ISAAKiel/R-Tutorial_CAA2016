...
```{r} 
R <- data.frame(V1 = c(1,2,3,4), V2 = c(3.5,4.3,5.6,6.5), V3 = c("A","A","B","A"))
...
**geom**etric objects: Elemente, aus denen sich der Plot zusammen setzt - z.B. Punkte, Balken, Linien etc.  
...
**scales**: Spezifizierung der Zuordnung von Daten zu Grafischer Veranschaulichung (data -> aes). Scales steuern die Erstellung von Legenden und (bis zu einem gewissen Grad) Achsen
